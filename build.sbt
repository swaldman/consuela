...
libraryDependencies ++= Seq(
  ...
  "com.mchange"             %% "mchange-commons-scala"           % "0.4.4-SNAPSHOT"  changing(),
  "com.mchange"             %% "literal"                         % "0.0.2",
  "com.mchange"             %% "mchange-play-json-util"          % "0.0.2-SNAPSHOT"  changing(),
  "com.mchange"             %% "jsonrpc-client"                  % "0.0.2-SNAPSHOT"  changing(),
  "com.mchange"             %  "mchange-commons-java"            % "0.2.15-SNAPSHOT" changing(),
