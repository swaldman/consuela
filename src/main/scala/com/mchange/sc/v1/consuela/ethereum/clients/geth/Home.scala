...
object Home {
  val Directory = {
    ...
    Platform.Current match {
      ...
      case Some( unknown )          => fail( s"Uncertain of appropriate geth home directory for Platform ${unknown}" )
      case None                     => fail( "Could not detect platform to determine the location of the geth home directory" )
    }
  }
}
